...
public class BootstrapData implements CommandLineRunner{
    ...
    public void run(String... args) throws Exception {
        ...
        Student student2 = new Student("Daffy", "Duck",10, class2);
        Student student3 = new Student("Porky", "Pig",10, class3);
        Student student4 = new Student("Speedy", "Gonzales",10, class1);
        Student student5 = new Student("Wile", "Coyote",10, class2);
